...
public class AnalysisAndNotificationServiceOld extends Service
    ...
    private ArrayList<Double> mrrValues;
    private ArrayList<Double> rmssdValues;
    ...
    public AnalysisAndNotificationServiceOld() {}
    ...
    private final BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            SharedPreferences mPreferences = PreferenceManager.getDefaultSharedPreferences(
                    AnalysisAndNotificationServiceOld.this);
            ...
            if(action.equals(BleService.ACTION_DATA_AVAILABLE)){
                ...
                if(timeStampCurrentTime - timeStampLastCalculation
                    ...
                    if(foundSignificantEntryActivityType != null){
                        ...
                        Intent intentQuestionnaire = new Intent(AnalysisAndNotificationServiceOld.this, QuestionnaireActivity.class);
...
//                        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                        ...
                        AnalysisAndNotificationServiceOld.this.throwQuestionnaireNotification(
                                AnalysisAndNotificationServiceOld.this, pendingIntentArousalInput);
                    }
